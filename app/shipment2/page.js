...
export default function Page() {
  ...
  const handleSearchOrder = (e) => {
    ...
    setForm((f) => ({
      ...
      provinciaDestinatario:
        ship.country_code === "IT" ? ship.province_code || "" : ship.provincia || ship.province_code || "",
  ...
  const handleCreaECompletaEPaga = async (idSim) => {
    ...
    setErrore(null);
    try {
      // ⬇️ **FIX**: create su Spediamo **store 2** per leggere indirizzo dallo store 2
      ...
      const motivo =
        dataP.message || dataP.error || (typeof dataP === "string" ? dataP : "") || JSON.stringify(dataP, null, 2);
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={cardStyle}>
        <h2 style={headerStyle}>Gestione Spedizioni Shopify · Store 2</h2>
